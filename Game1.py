...
pygame.display.set_caption("Imported Image Example")

# Load the character image
character_image = pygame.image.load("Knight-Idle.gif")
character_image = pygame.transform.scale(character_image, (100, 100))  # Resize the image
